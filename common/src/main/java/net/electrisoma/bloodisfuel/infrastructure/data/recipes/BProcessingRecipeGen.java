...
public abstract class BProcessingRecipeGen extends CreateRecipeProvider {

    protected static final List<BProcessingRecipeGen> GENERATORS = new ArrayList<>();

    public static DataProvider registerAll(DataGenerator gen, FabricDataOutput output) {
    ...
    public BProcessingRecipeGen(FabricDataOutput generator) {
        super(generator);
    }
