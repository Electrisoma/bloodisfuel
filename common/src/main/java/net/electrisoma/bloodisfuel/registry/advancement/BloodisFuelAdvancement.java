...
public class BloodisFuelAdvancement {
    ...
    private SimpleBloodisFuelTrigger builtinTrigger;
    private BloodisFuelAdvancement parent;
    ...
    public BloodisFuelAdvancement(String id, UnaryOperator<Builder> b) {
        ...
        if (!t.externalTrigger) {
            builtinTrigger = BTriggers.addSimple(id + "_builtin");
    ...
    public boolean
    isAlreadyAwardedTo(Player player) {
    ...
    @ApiStatus.Internal
    public void
    provideLang(BiConsumer<String, String> consumer) {
    ...
    public class Builder {
        ...
        @ApiStatus.Internal
        public Builder
        after(BloodisFuelAdvancement other) {
            BloodisFuelAdvancement.this.parent = other;
            return this;
        }

        @ApiStatus.Internal
        public Builder
        icon(ItemProviderEntry<?> item) {
        ...
        public Builder
        title(String title) {
            BloodisFuelAdvancement.this.title = title;
            return this;
        }
        ...
        description(String description) {
            BloodisFuelAdvancement.this.description = description;
            return this;
        }

        @ApiStatus.Internal
        public Builder
        whenBlockPlaced(Block block) {
        ...
        @ApiStatus.Internal
        public Builder
        whenItemCollected(ItemProviderEntry<?> item) {
        ...
        @ApiStatus.Internal
        public Builder
        externalTrigger(CriterionTriggerInstance trigger) {
