...
public class BClient extends ConfigBase {
    ...
    public final ConfigGroup client =
            group(0, "client", Comments.client);
    ...
    public final ConfigFloat oilEnrichedBloodTransparencyMultiplier =
            f(1,.125f,128,"oil_enriched_blood", Comments.oilEnrichedBloodTransparencyMultiplier);

    public final ConfigFloat dieselInfusedBloodTransparencyMultiplier =
            f(1,.125f,128,"diesel_infused_blood", Comments.dieselInfusedBloodTransparencyMultiplier);

    public final ConfigFloat gasolineInfusedBloodTransparencyMultiplier =
            f(1,.125f,128,"gasoline_infused_blood", Comments.gasolineInfusedBloodTransparencyMultiplier);
