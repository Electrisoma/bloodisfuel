...
public class BBlockEntityTypes {
    ...
    public static final BlockEntityEntry<PortableEngineBlockEntity> PORTABLE_ENGINE = REGISTRATE
            ...
            .register();
    public static final BlockEntityEntry<VampireEngineBlockEntity> VAMPIRE_ENGINE = REGISTRATE
            ...
            .register();
    public static final BlockEntityEntry<BloodExtractorBlockEntity> BLOOD_EXTRACTOR = REGISTRATE
