...
public class VampireEngineBlockEntityRenderer extends ShaftRenderer<VampireEngineBlockEntity> {
    public VampireEngineBlockEntityRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }

    protected void renderSafe(VampireEngineBlockEntity be, float partialTicks, PoseStack ms, MultiBufferSource buffer,
