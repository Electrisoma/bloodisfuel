...
public class BMixingRecipeGen extends MixingRecipeGen {
    ...
    ENRICHED_BLOOD_FROM_SUGARS = create("enriched_blood_from_carbohydrates", b -> b
            .require(BTags.BFluidTags.BLOOD.tag,1000)
            .require(BTags.BItemTags.CARBOHYDRATES.tag)
            .requiresHeat(HeatCondition.SUPERHEATED)
            .output(BFluids.ENRICHED_BLOOD.get(), 500)),
    ENRICHED_BLOOD_FROM_LIQUID_SUGARS = create("enriched_blood_from_liquid_carbohydrates", b -> b
