...
//                && (!a.hasTag() && !b.hasTag() || (a.hasTag() && a.getTag().equals(b.getTag())));
//    }
//    private static String getNormalizedFluidKey(FluidStack stack) {
...
//    }
//
//    private static Potion getPotion(FluidStack fs) {
...
//        return null;
//    }
//    private static int getPotionAmplifier(FluidStack fs) {
//        if (fs.hasTag() && fs.getTag().contains("Potion")) {
