...
public class defaultLang {
    ...
    public static void provideLang(BiConsumer<String, String> consumer) {
        ...
        tooltipCondition(consumer, blade, "Click with Bucket in Inventory", 2);
        tooltipBehaviour(consumer, blade, "Fill with _fluid_ while in your _inventory_", 2);
        tooltipCondition(consumer, blade, "Hold R-Click", 3);
        tooltipBehaviour(consumer, blade, "Extract _fluid_ from self while empty, Inject _fluid_ in self while full", 3);
        tooltipCondition(consumer, blade, "R-Click while Sneaking", 4);
        tooltipBehaviour(consumer, blade, "Drain _fluid_", 4);
        ...
        tooltipCondition(consumer, gun, "Click with Bucket in Inventory", 2);
        tooltipBehaviour(consumer, gun, "Fill with _fluid_ while in your _inventory_", 2);
        tooltipCondition(consumer, gun, "R-Click while Sneaking", 3);
        tooltipBehaviour(consumer, gun, "Drain _fluid_", 3);
        ...
        tooltipMisc(consumer,"slow", "Slowness");
        tooltipMisc(consumer,"freezing", "Freezing");
        tooltipMisc(consumer,"heal", "hp");
        tooltipMisc(consumer,"teleportation", "Teleportation");
        tooltipMisc(consumer,"diameter", "⌀");
