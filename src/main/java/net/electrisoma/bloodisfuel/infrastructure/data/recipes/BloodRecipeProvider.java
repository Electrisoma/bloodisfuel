...
public class BloodRecipeProvider extends RecipeProvider {
    protected final List<GeneratedRecipe> all = new ArrayList<>();

    public BloodRecipeProvider(PackOutput output) {super(output);}
    ...
    protected static class I {
        ...
        static ItemLike leather() {return Items.LEATHER;}
    }
}
