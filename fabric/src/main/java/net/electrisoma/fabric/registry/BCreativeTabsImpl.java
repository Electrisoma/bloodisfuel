...
import net.electrisoma.bloodisfuel.registry.BCreativeTabs.RegistrateDisplayItemsGenerator;
import net.electrisoma.bloodisfuel.registry.BCreativeTabs.TabInfo;
...
public class BCreativeTabsImpl {
    ...
    private static final TabInfo MAIN_TAB = register("main",
            () -> FabricItemGroup.builder()
                    .title(Component.translatable("itemGroup.base"))
