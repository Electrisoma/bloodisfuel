...
public class FluidBuilderImpl<T extends BFlowingFluid, P> extends FluidBuilder<T, P> {
    ...
    public FluidBuilderImpl(AbstractRegistrate<?> owner, P parent, String name, BuilderCallback callback, ResourceLocation stillTexture, ResourceLocation flowingTexture, NonNullFunction<BFlowingFluid.Properties, T> factory) {
